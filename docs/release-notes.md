# 日本語おまかせ作曲 / Japanese Song Creation — 20260914063527
...
配布ZIP：`YuE2_Japanese_LMStudio_20260914063527.zip`。モデル・生成曲・認証情報は含みません。Source code ZIPではなく、この配布ZIPを使ってください。
...
Download `YuE2_Japanese_LMStudio_20260914063527.zip`, not GitHub's automatic Source code ZIP. Model weights, generated songs and credentials are excluded.
...
Tag: `yue2-20260914063527`. Version: `20260914063527`.
